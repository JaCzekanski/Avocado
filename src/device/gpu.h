...
class GPU : public Device {
   ...
   public:
    ...
    void setRenderer(SDL_Renderer* renderer) {
        ...
        texture = SDL_CreateTexture(renderer, SDL_PIXELFORMAT_BGR888, SDL_TEXTUREACCESS_STREAMING,
                                    1024, 512);
        SCREEN = SDL_CreateTexture(renderer, SDL_PIXELFORMAT_BGR888, SDL_TEXTUREACCESS_STREAMING,
                                   640, 480);
    }
};
}
