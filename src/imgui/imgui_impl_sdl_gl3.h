...
// ImGui_ImplXXXX_Shutdown(). If you are new to ImGui, see examples/README.txt and documentation at the top of imgui.cpp.
...
IMGUI_API bool ImGui_ImplSdlGL3_Init(SDL_Window* window, const char* glsl_version = nullptr);
